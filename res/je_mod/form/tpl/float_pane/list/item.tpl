...
<div 	class="josi_store_item_div order_item_div"
		...
		<!--показываем список команд доступный для данного элемента-->
			[[
				...
				^
				tpl_res:				&
				tpl_path:				tpl/popup/form_popup_cmd_list_switch.scl&
				drop_comment:			true&
				cmd_group_arr:			 'add_cmd','dub_cmd','drop_cmd','zamer_item','change_status' &
				cmd_group_query:		 '#.group#' == 'edit_cmd' \&\& (new Date()).getTime()\<
										(new Date((new Date()).getFullYear(),(new Date()).getMonth(),
										(new Date()).getDate(),17,45,0)).getTime() &
				node_class_query:		&
				parse_arr:				false&
				rooted:					true&
				service_name:			[[f:kvl_1_mix_val^mix_key:service_name]]&
				service_res_name:		[[f:kvl_1_mix_val^mix_key:service_res_name]]&
				context_res_key:		[[f:kvl_1_mix_val^mix_key:context_struct_res_key]]&
				relat_id_val:			[[f:struct_val^key:.id]]&
				res_item_id:			[[f:struct_val^key:.id]]&
				context_service_name:	[[f:kvl_1_mix_val^mix_key:context_service_name]]&
				context_service_res_name:[[f:kvl_1_mix_val^mix_key:context_service_res_name]]&
				item_list_node_class_query:[[f:kvl_1_mix_val^mix_key:item_list_node_class_query]]&k:v
			]]
	...
	<div style="width:100%;overflow: hidden;">
		...
		<div class="order_item_val_div div_left"
			...
			<div>
				...
				[[f:struct_val^key:.tab_status.0.name]]
				[[f:struct_val^key:.reason]]
			</div>
