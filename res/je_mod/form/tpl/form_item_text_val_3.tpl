...
<div class="josi_store_form_item" style="height: [[f:kvl_1_mix_val^mix_key:val_h&def_val:auto]]">
	...
	<div class="div_left josi_store_form_item_val_div" style="width: [[f:kvl_1_mix_val^mix_key:val_w&def_val:50]]%;height:95%">
		<div style="height:95%">
			<div 	class="josi_store_form_input_div text_val form_val [[f:kvl_1_mix_val^mix_key:val_div_stl_class]]" 
					style_="width: 100%"
					style="height: 95%;margin: 0;color: #666;font-weight: normal;
							font-size: 16px;"
