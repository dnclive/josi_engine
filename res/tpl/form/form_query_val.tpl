	...
	<div class="div_left josi_store_form_item_val_div" style="width: [[f:kvl_1_mix_val^mix_key:val_w&def_val:50]]%;">
		<div 	class="div_left josi_store_form_item_val_div" 
				...
				"
					f:clear_node
					^
					node_class_query:		.zamer_mix_val&
					rooted:					true
					...
					f:tpl
					^
					tpl_path:				[[f:kvl_1_mix_val^mix_key:popup_form_val_tpl]]&
					node_class_query:		.zamer_mix_val&
					rooted:					true&
					replace:				true&
					append:					false&
					...
					struct_res_key:			form.[[f:kvl_1_mix_val^mix_key:service_name]]
				...
				<div 	class="josi_store_form_input_div text_val " 
						style="min-height: 22px;"
						data-josi-form-key="[[f:kvl_1_mix_val^mix_key:val_key]]" 
						data-josi-ev-stop=true 
						contenteditable=true
						data-josi-ev-keys-prevent="ENTER|DOWN_ARROW|UP_ARROW" 
						data-josi-ev-resp="blur,keydown,key_press,click,change_val" 
						...
						<!--выбираем следующий вариант если нажата клавиша Стерлка вниз-->
							...
							f:select_list_item
							^
							list_class_name:		item_list&
							item_class_name:		item&
							rooted:					true&
							root_node_class_name:	josi_store_form_item&
							select:					next&
							selected_class_name:	form_popup_list_item_div_selected
						...
						<!--при потере фокуса ввода или нажатии клавиши enter скрываем всплывающее окно-->
							...
							^
							popup_class_name:		popup_list_div&
							rooted:					true&
							root_node_class_name:	josi_store_form_item
						...
						<!--показываем форму ввода если не были найдены варианты-->
							ev:			{keydown}&
							key:		{!DOWN_ARROW,!UP_ARROW,!ENTER,!TAB}&
							if_exp:		 '#struct_get_arr.form.[[f:kvl_1_mix_val^mix_key:tab_key]].0.name#' == '' &
							...
							^
							tpl_key:				&
							tpl_path:				[[f:kvl_1_mix_val^mix_key:popup_form_tpl]]&
							node_class_query:		.popup_list_div&
							struct_res_key:			struct_put_arr.[[f:kvl_1_mix_val^mix_key:service_name]].
													[[f:kvl_1_mix_val^mix_key:service_res_name]].0&
							replace:				true&
							rooted:					true&
						...
						<!--при получении фокуса или щелчке скрываем/показываек окно-->
							ev:{focus,click}
							^
						...
						<!--при щелчке запрашиваем ресурс запроса если еще не загружен-->
							ev:{click}
							^
							f:res_struct_req
							^
							req_res_name:			res/where/form/[[f:kvl_1_mix_val^mix_key:tab_key]]&
							place_from:				[[f:kvl_1_mix_val^mix_key:tab_key]]&
							place_to:				struct_get_query_arr.form.[[f:kvl_1_mix_val^mix_key:tab_key]]&
							replace:				false
						...
						<!-- Копируем введенное значение как фильтр в структуру запроса -->
							...
							f:struct_rel
							^
							place_from:				[[f:kvl_1_mix_val^mix_key:val_key]]&
							place_to:				struct_get_query_arr.form.[[f:kvl_1_mix_val^mix_key:tab_key]].0.
													[[f:kvl_1_mix_val^mix_key:filter_key]]&
							replace:true
							
							>
						
						<!-- Запрашиваем элементы соответсвующие текущему запросу -->
							ev:{keydown,keypress}
							^
							f:josi_store_trans
							^
							place_to:				struct_get_arr.form.[[f:kvl_1_mix_val^mix_key:tab_key]]&
							get_dot_key:			struct_get_query_arr.form.[[f:kvl_1_mix_val^mix_key:tab_key]]&
							replace:				true&
							req_seq:				customer
						...
						<!-- Выводим варианты во всплывающий список -->
							ev:			{keydown,keypress}&
							key:		{!DOWN_ARROW,!UP_ARROW,!ENTER,!TAB}&
							if_exp:		 '#[[f:kvl_1_mix_val^mix_key:val_key]]#' != ''||1==1 &
							calc_key_limiter:true
							^
							f:tpl&
							kvl_context:true
							^
							tpl_key:				&
							tpl_path:				tpl/order/form/popup/list/item.tpl&
							node_class_query:		.popup_list_div&
							struct_res_key:			struct_get_arr.form.[[f:kvl_1_mix_val^mix_key:tab_key]]&
							where_key:				[[f:kvl_1_mix_val^mix_key:val_key]]&
							val_key_1:				[[f:kvl_1_mix_val^mix_key:val_key_1]]&
							context_key:			[[f:kvl_1_mix_val^mix_key:context_struct_res_key]]&
							replace:				true&
							rooted:					true&
							root_node_class_name:	josi_store_form_item_val_div&
							append:					false&
							parse_arr:				true&
							place_from_key:			[[f:kvl_1_mix_val^mix_key:place_from_key]]&
							tpl_seq:				customer
						...
						<!--показываем форму ввода если не были найдены варианты-->
							...
							f:clear_node
							^
							class_name:.josi_store_item_arr_div
